---
name: ds-component-pipeline
description: >
  The authoritative process rule for creating or changing a design-system
  component: the PR-1 / PR-2 boundary, the mandatory human spec-merge checkpoint,
  the visual draft before the freeze, the retrofit path for a component with no
  spec, the review-round budget and what counts as a blocker, and which
  enforcement mechanism fires at which kit level. Read this before writing any
  component spec, component source, story or token file, and before opening any
